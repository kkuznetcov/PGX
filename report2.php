<?php 
	try{
		...
		$pdf->SetFont('dejavusans', '', 10, '', true); // безопасный
		...
		//левая колонка
		$pdf->writeHTMLCell(40, '295', '1', '1', $left_column, 0, 0, 1, false, 'J', true);
		...
		$table1 = "<table>";
		$table1 .= "<tr><td><strong>Фамилия</strong></td><td>$InputSurname</td><td><strong>ID</strong></td><td>$InputId</td></tr>";
		$table1 .= "<tr><td>Имя</td><td>$InputFirstName</td><td>Дата рождения</td><td>$InputBirth</td></tr>";
		$table1 .= "<tr><td>Отчество</td><td>$InputSecondName</td><td>Пол</td><td>$InputSex</td></tr>";
		$table1 .= "<tr><td>Вес</td><td>$InputWeight</td><td>Раса</td><td>$InputRase</td></tr>";
		$table1 .= "<tr><td>Рост</td><td>$InputHeight</td><td>Дата</td><td>$InputDate</td></tr>";
		$table1 .= "</table>";
		...
		// вывод подписи 
		$pdf->WriteHTMLCell(100, 20, '85', '240', "$sign", 0,0);
		...
		//вывод колонки
		$pdf->writeHTMLCell(21, '295', '1', '1', $left_column, 0, 0, 1, true, 'J', false);
		...
		$table2 = "<table>";
		$table2 .= "<tr><td><strong>Фамилия</strong></td><td>$InputSurname</td><td><strong>ID</strong></td><td>$InputId</td></tr>";
		$table2 .= "<tr><td>Имя</td><td>$InputFirstName</td><td>Дата рождения</td><td>$InputBirth</td></tr>";
		$table2 .= "<tr><td>Отчество</td><td>$InputSecondName</td><td>Пол</td><td>$InputSex</td></tr>";
		$table2 .= "<tr><td>Вес</td><td>$InputWeight</td><td>Раса</td><td>$InputRase</td></tr>";
		$table2 .= "<tr><td>Рост</td><td>$InputHeight</td><td>Дата</td><td>$InputDate</td></tr>";
		$table2 .= "</table>";
	
		//вывод таблицы
		$pdf->WriteHTMLCell(140, 30, '23', '20', "$table2", 1,0);
